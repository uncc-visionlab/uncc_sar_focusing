...
def MobileNetV2(input_image = (224,224,3), n_classes=1000):
    input = tf.keras.Input(input_image)
...
for input_size in input_sizes:
    ...
    logdir = os.path.join("Logs3", "custom_model2_grad_"+str(input_size))
    ...
    gradcam_callback = GradCAMCallback(sample_batch, logdir)
    ...
    custom_model.save("Model/new_224_grad")
